...
class Db
{
    ...
    */
        public function __construct( )
        {
            ...
            $this->settings["dbname"] = $config['db']['dev']['dbname'];
            $this->settings["host"] = $config['db']['dev']['host'];
            $this->settings["username"] = $config['db']['dev']['username'];
            $this->settings["password"] = $config['db']['dev']['password'];
        ...
        */
        private function Connect()
        {
            ...
            $dns = 'mysql:dbname='.$this->settings["dbname"].';host='.$this->settings["host"].'';
